...
import com.lixm.chat.callback.DngSessionCallback;
import com.lixm.chat.callback.JpegSessionCallback;
import com.lixm.chat.callback.PreviewSessionCallback;
import com.lixm.chat.listener.AwbSeekBarChangeListener;
import com.lixm.chat.listener.JpegReaderListener;
import com.lixm.chat.listener.TextureViewTouchEvent;
import com.lixm.chat.util.PreferenceHelper;
import com.lixm.chat.view.AnimationImageView;
import com.lixm.chat.view.AnimationTextView;
import com.lixm.chat.view.AwbSeekBar;
import com.lixm.chat.view.MyTextureView;
...
public class DisplayFragment extends Fragment implements View.OnClickListener {
    ...
    private CameraCaptureSession.StateCallback mSessionPreviewStateCallback = new CameraCaptureSession.StateCallback() {
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            ...
            Log.i(".StateCallback", "mSessionStateCallback--->onConfigured");
            try {
        ...
        public void onConfigureFailed(CameraCaptureSession cameraCaptureSession) {
            Log.i("StateCallback", "mSessionStateCallback--->onConfigureFailed");
        ...
        public void onReady(CameraCaptureSession session) {
            ...
            Log.i("StateCallback", "mSessionStateCallback--->onReady");
        }

        @Override
        public void onActive(CameraCaptureSession session) {
            super.onActive(session);
            Log.i("StateCallback", "mSessionStateCallback--->onActive");
        }

        @Override
        public void onClosed(CameraCaptureSession session) {
            super.onClosed(session);
            Log.i("StateCallback", "mSessionStateCallback--->onClosed");
        }
    };
