...
import com.lixm.chat.util.AbstractPathAnimator;
import com.lixm.chat.util.PathAnimator;
...
//    private static HeartThread heartThread;
    ...
    private void findViewById(Context context) {
        ...
        try {
            bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.icon_copper1);
...
//    }
    ...
    private static int[] drawableIds = new int[]{R.mipmap.icon_copper1, R.mipmap.icon_copper2, R.mipmap.icon_copper3, R.mipmap.icon_copper4, R.mipmap.icon_copper5, R.mipmap.icon_copper1, R.mipmap.icon_copper2, R.mipmap.icon_copper3, R.mipmap.icon_copper4,};
    private Random random = new Random();

    public void addFavor() {
        HeartView heartView = new HeartView(getContext());
        heartView.setDrawable(drawableIds[random.nextInt(8)]);
        LayoutParams params=new LayoutParams(15,20);
